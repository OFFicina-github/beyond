...
if ( !function_exists( 'nectar_shop_wrapper_start' ) ) {
	function nectar_shop_wrapper_start() {
		echo '<div class="container-wrap" data-midnight="dark" role="main">';
...
// Regenerate CSS when woocommerce is activated.
add_action('activate_plugin', 'nectar_woocommerce_activation_callback', 10, 2);
if ( !function_exists('nectar_woocommerce_activation_callback') ) {
	function nectar_woocommerce_activation_callback($plugin, $network_wide) {
