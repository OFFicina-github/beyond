...
if ( ! function_exists( 'nectar_get_required_plugins_list' ) ) {
	/**
	 * Retrieve the Salient bundled/required plugins configuration.
	 *
	 * @return array[]
	 */
	function nectar_get_required_plugins_list() {
		...
		return array(
			...
			array(
				...
				'plugin_file'  => 'js_composer_salient/js_composer.php',
				'source'       => get_template_directory() . '/plugins/js_composer_salient.zip', // The plugin source
				'required'     => true, // If false, the plugin is only 'recommended' instead of required
				'version'      => '8.6.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			...
			array(
				'name'               => 'Salient Core',
				'slug'               => 'salient-core',
				'plugin_file'        => 'salient-core/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-demo-importer/plugin.php',
			...
			array(
				'name'               => 'Salient Social',
				'slug'               => 'salient-social',
				'plugin_file'        => 'salient-social/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-widgets/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-portfolio/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-nectar-slider/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-home-slider/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-shortcodes/plugin.php',
			...
			array(
				...
				'plugin_file'        => 'salient-custom-branding/plugin.php',
...
function nectar_register_required_plugins() {
	...
	$plugins = nectar_get_required_plugins_list();
